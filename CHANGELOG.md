...
- Fixed `miden-vm bundle` to derive its default `.masp` output path from the root module name instead
  of silently overwriting a fixed `out.masp` file ([#3801](https://github.com/0xMiden/miden-vm/issues/3801)).
